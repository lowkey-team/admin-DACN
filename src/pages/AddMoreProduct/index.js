...
import {Input, Button, Row as AntRow, Col, Upload, Image, message, Table } from 'antd';
        ...
        <div className={cx('wrapper', 'container')}>
            ...
            <div className={cx('table-add')}>
                            ...
                            <td className={cx('row-add')}>
                                ...
                                <div className={cx('variant-section')}>
                                    ...
                                    {variants.map((variant, index) => (
                                        <AntRow gutter={16} key={index} align="middle" className={cx('row-variant')}>
                ...
                <p className={cx('btn__add-row')}>
                    <button onClick={addRow}>Thêm dòng mới <FontAwesomeIcon icon={faAnglesDown}/></button>
                </p>
            </div>  
        </div>
     );
